\project{\github{browningluke/mangathrV2}{MangathrV2 (Go \& TypeScript/Node.js)}}{Apr 2021 – Present}{
  ...
  \item Rewrote entire application in Golang, to improve performance and executable size.
  \item Rewrite supports multiple database \& metadata types, as well as a greater number of configuration options.
}
